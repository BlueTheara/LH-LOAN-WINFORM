...
namespace Micro_Finance.REPORTFILE {
    ...
    public class RPT_DAY_END1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Micro_Finance.REPORTFILE.RPT_DAY_END1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_DAY_END1 : Component, ICachedReport {
        
        public CachedRPT_DAY_END1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_DAY_END1 rpt = new RPT_DAY_END1();
            rpt.Site = this.Site;
            return rpt;
        }
