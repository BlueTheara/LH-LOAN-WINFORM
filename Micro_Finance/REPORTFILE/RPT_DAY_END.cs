...
namespace Micro_Finance.REPORTFILE {
    ...
    public class RPT_DAY_END : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Micro_Finance.REPORTFILE.RPT_DAY_END.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_DAY_END : Component, ICachedReport {
        
        public CachedRPT_DAY_END() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_DAY_END rpt = new RPT_DAY_END();
            rpt.Site = this.Site;
            return rpt;
        }
