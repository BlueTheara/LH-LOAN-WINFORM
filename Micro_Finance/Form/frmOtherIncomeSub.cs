...
{
    public partial class frmOtherIncomeSub : Form
    {
        public frmOtherIncomeSub()
        {
            InitializeComponent();
        }
        public string vAction = "ADD";
        public frmOtherIncome fCo;
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "ADD_OTHER_INCOME", vAction + "[.,;TNC,;.]" + ClsGlouble.f_integer(t_id.Text.Trim()) + "[.,;TNC,;.]" + ClsGlouble.f_integer(c_coa.SelectedValue) + "[.,;TNC,;.]" + t_date.Value.ToString("yyyy-MM-dd") + "[.,;TNC,;.]" + t_desc.Text.Trim() + "[.,;TNC,;.]" + ClsGlouble.f_double(t_amt.Text.Trim()) });
        ...
        private void frmCOSub_Load(object sender, EventArgs e)
        {
            ...
            DataSet tempDs = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "ADD_OTHER_INCOME_LOAD", ClsGlouble.f_integer(t_id.Text.Trim()) + "" });
