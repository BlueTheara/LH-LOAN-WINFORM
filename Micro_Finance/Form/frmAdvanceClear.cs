...
{
    public partial class frmAdvanceClear : Form
    {
        public frmAdvanceClear()
        {
            InitializeComponent();
        ...
        public void LoadData()
        {
            try
            {
                ...
                DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "LOAD_STAFF_ADVANCE_CLEAR", vDate });
                dgv.Rows.Clear();
                int i = 1;
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            frmAdvanceClearSub obj = new frmAdvanceClearSub();
            obj.vAction = "ADD";
            obj.fCo = this;
            obj.ShowDialog();
        }
            ...
            try
            {
                if (dgv.CurrentCell != null)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "DELETE_STAFF_ADVANCE_CLEAR", id + "" });
