    ...
    public partial class frmExpense : Form
    {
        ...
        public void LoadData()
        {
            try
            {
                ...
                DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "LOAD_EXPENSE", vDate });
                dgv.Rows.Clear();
                int i = 1;
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            frmExpenseSub obj = new frmExpenseSub();
            obj.vAction = "ADD";
            obj.fCo = this;
            obj.ShowDialog();
        }
            ...
            try
            {
                if (dgv.CurrentCell != null)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "DELETE_EXPENSE", id + "" });
