    ...
    public partial class frmWithdraw : Form
    {
        ...
        public void LoadData()
        {
            try
            {
                ...
                DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "LOAD_CAPITAL_WITHDRAW", vDate });
                dgv.Rows.Clear();
                int i = 1;
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            frmWithdrawSub obj = new frmWithdrawSub();
            obj.vAction = "ADD";
            obj.fCo = this;
            obj.ShowDialog();
        }
            ...
            try
            {
                if (dgv.CurrentCell != null)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "DELETE_CAPITAL_WITHDRAW", id + "" });
