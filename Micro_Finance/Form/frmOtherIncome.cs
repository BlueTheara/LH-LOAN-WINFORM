    ...
    public partial class frmOtherIncome : Form
    {
        ...
        public void LoadData()
        {
            try
            {
                ...
                DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "LOAD_OTHER_INCOME", vDate });
                dgv.Rows.Clear();
                int i = 1;
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            frmOtherIncomeSub obj = new frmOtherIncomeSub();
            obj.vAction = "ADD";
            obj.fCo = this;
            obj.ShowDialog();
        }
            ...
            try
            {
                if (dgv.CurrentCell != null)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "DELETE_OTHER_INCOME", id + "" });
